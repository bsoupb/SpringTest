...
public interface RecruitRepository extends JpaRepository<Recruit, Integer> {
	...
	// type 컬럼 일치하고 연봉 기준으로 내림차순 3개 조회
	...
	public List<Recruit> findByDeadlineAndTypeOrderSalaryDesc(@Param("type") String type, @Param("salary") int salary, @Param("deadline") String deadline);
}
